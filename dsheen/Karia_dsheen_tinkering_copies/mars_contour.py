    ...
    from galcoord import get_mars_altaz
    ...
    folder='mars_contour/'
    savetitle='mars_scan_vectors.txt'
    ...
    print 'Locating mars...'
    sun_altaz=get_mars_altaz()
    print 'mars located at ' + str(mars_altaz[0]) + 'azimuth , ' + str(mars_altaz[1]) + ' elevation.'
    print 'Moving to mars location...'
    point(mars_altaz[0], mars_altaz[1])
    wait(10)
    print "Ready to scan."
    print ' '

    #do the survey
    mars_altaz=get_mars_altaz() #recheck sun again
    relative_el=(1)*scan_offset #start at left of elevation
    el=mars_altaz[1]+relative_el
