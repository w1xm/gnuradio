...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.if_bandwidth_1 = if_bandwidth_1 = 1.5e6
        self.sdr_gain = sdr_gain = 70
        ...
        self.sdr_frequency = sdr_frequency = 1296.0e6
        ...
        self.integration_scale_factor = integration_scale_factor = np.full((num_channels),float(1.0/(integration_time*50)),dtype=float)
